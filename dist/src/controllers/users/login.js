...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const validatePassword = yield (0, encrypt_1.comparePassword)(password, checkUserPassword);
        if (!validatePassword)
            return res.status(400).send((0, errorJson_1.errorJson)('Email or password are incorrect'));
