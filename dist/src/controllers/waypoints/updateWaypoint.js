...
exports.updateWaypoint = void 0;
const middlewares_1 = require("../../middlewares");
const utils_1 = require("../../utils");
const errorJson_1 = require("../../helpers/errorJson");
const updateWaypoint = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const newWaypoint = yield (0, utils_1.updateWaypointFn)(id, +waypointId, lng, lat);
